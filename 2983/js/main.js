$(document).ready(function() {
  ...
  var checkRolletsTimer = null;
  function checkRollets() {
    var oks = [];
    $(".main-fortune__wrapper-1, .main-fortune__wrapper-2, .main-fortune__wrapper-3").each(function() {
      oks.push($(this).children('.main-fortune__percent--active').attr('data-active') == "true" ? 1 : 0);
    });

    if (oks[0] == 1 && oks[1] == 1 && oks[2] == 1) {
      ...
      clearTimeout(checkRolletsTimer);
      checkRolletsTimer = setTimeout(checkRolletsTimer, 50);
    }
  }
